...
breaking all five flows---a textbook disproportionate action; and the misconfigurations
occupy exactly the high-advantage, zero-collateral frontier (1.65/0.98/0.95 at zero
flows), while the seven revocations against the largest grant-holder \emph{jointly}
yield less (1.8)---privilege-count de-scoping is not merely inefficient but, in the
proportionality sense, inadmissible. The ranking also yields a compact defensive
