...
experiment with live RBAC, predicted confidentiality blast radius reproduces the actually
...
dependency-only view misses, while a read-only agent identity exfiltrates zero
secrets under real compromise. As
